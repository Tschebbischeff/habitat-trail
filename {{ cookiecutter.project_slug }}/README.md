...
![Version](https://img.shields.io/badge/dynamic/json?label=Version&color=yellow&style=flat&url={{ cookiecutter.__project_url_raw_enc }}%2Frefs%2Fheads%2Fmain%2Fmetadata.json&query=%24.version)
...
Copyright (c) 2026, [{{ cookiecutter.author_profile_name }}]({{ cookiecutter.author_profile_url }}). \
